...
class TidewaterApi:
    ...
    def get_station_by_id(
        ...
        _param = self._get_station_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_station_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_station_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_station_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/oceanObs/collections/tidewaterstation/items/{id}',
    ...
    def get_stations(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="NOTE - the parameter is added du to the OGC requirements, but no search restrictions are implemented.Datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        ...
        :param datetime: NOTE - the parameter is added du to the OGC requirements, but no search restrictions are implemented.Datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339
        :type datetime: str
        ...
        _param = self._get_stations_serialize(
            datetime=datetime,
    ...
    @validate_call
    def get_stations_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="NOTE - the parameter is added du to the OGC requirements, but no search restrictions are implemented.Datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=300000, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    @validate_call
    def get_stations_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="NOTE - the parameter is added du to the OGC requirements, but no search restrictions are implemented.Datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=300000, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    def _get_stations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/oceanObs/collections/tidewaterstation/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_tidewater(
        ...
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by tidewaterStationId")] = None,
        prediction_type: Annotated[Optional[StrictStr], Field(description="Filter by predictionType")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=300000, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="number of results to skip before returning matching results")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Order by which to return results. Default is not sorted")] = None,
        bbox: Annotated[Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=4, max_length=6)]], Field(description="Select tidewater within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)")] = None,
        bbox_crs: Annotated[Optional[StrictStr], Field(description="Which coordinate reference system to use. Only the CRS84 is supported")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type datetime: str
        :param station_id: Filter by tidewaterStationId
        :type station_id: str
        :param prediction_type: Filter by predictionType
        ...
        :type sortorder: str
        :param bbox: Select tidewater within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)
        :type bbox: List[float]
        :param bbox_crs: Which coordinate reference system to use. Only the CRS84 is supported
        :type bbox_crs: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_tidewater_serialize(
            datetime=datetime,
            station_id=station_id,
    ...
    @validate_call
    def get_tidewater_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by tidewaterStationId")] = None,
        prediction_type: Annotated[Optional[StrictStr], Field(description="Filter by predictionType")] = None,
    ...
    @validate_call
    def get_tidewater_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by tidewaterStationId")] = None,
        prediction_type: Annotated[Optional[StrictStr], Field(description="Filter by predictionType")] = None,
    ...
    def _get_tidewater_serialize(
        ...
        if prediction_type is not None:
            ...
            _query_params.append(('predictionType', prediction_type))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/oceanObs/collections/tidewater/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_tidewater_by_id(
        ...
        _param = self._get_tidewater_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tidewater_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tidewater_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_tidewater_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/oceanObs/collections/tidewater/items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
