...
class OceanObservationApi:
    ...
    def get_observation(
        ...
        period: Annotated[Optional[StrictStr], Field(description="Period from which to return results. Alternative to using datetime parameter")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        parameter_id: Annotated[Optional[StrictStr], Field(description="Filter by parameterId - see parameter list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Oceanographic_Observation_Data\">here</a>")] = None,
        ...
        :type datetime: str
        :param period: Period from which to return results. Alternative to using datetime parameter
        :type period: str
        :param station_id: Filter by stationId
        :type station_id: str
        :param parameter_id: Filter by parameterId - see parameter list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Oceanographic_Observation_Data\">here</a>
    ...
    def _get_observation_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/oceanObs/collections/observation/items',
    ...
    def _get_observation_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/oceanObs/collections/observation/items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
