...
class RadarDataVolumeFilesApi:
    ...
    def get_volume_feature_by_id(
        ...
        _param = self._get_volume_feature_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_volume_feature_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_volume_feature_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_volume_feature_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/radardata/collections/volume/items/{id}',
    ...
    def get_volume_features(
        ...
        _param = self._get_volume_features_serialize(
            datetime=datetime,
    ...
    @validate_call
    def get_volume_features_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the files for radar scans performed in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide radar data for the last 180 days")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        scan_type: Annotated[Optional[StrictStr], Field(description="Filter by scan type. For \"fullRange\" the range radius of the radars is 240 km, for \"doppler\" it is 120 km.")] = None,
    ...
    @validate_call
    def get_volume_features_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the files for radar scans performed in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide radar data for the last 180 days")] = None,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        scan_type: Annotated[Optional[StrictStr], Field(description="Filter by scan type. For \"fullRange\" the range radius of the radars is 240 km, for \"doppler\" it is 120 km.")] = None,
    ...
    def _get_volume_features_serialize(
        self,
        datetime,
        station_id,
        scan_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/radardata/collections/volume/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
