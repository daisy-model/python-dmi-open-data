...
from dmi_open_data.radardata.api_response import ApiResponse, T as ApiResponseT
import dmi_open_data.radardata.models
from dmi_open_data.radardata import rest
from dmi_open_data.radardata.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(dmi_open_data.radardata.models, klass)
