...
class WAMForecastDataGRIBFilesApi:
    ...
    def get_wamdw_feature_by_id(
        ...
        _param = self._get_wamdw_feature_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_wamdw_feature_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_wamdw_feature_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_wamdw_feature_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/forecastdata/collections/wam_dw/items/{id}',
    ...
    def get_wamdw_features(
        ...
        :type offset: int
        :param bbox: Select the WAM files covering an area that intersects with the bounding box. All files in this collection covers the same area. This means you either hit all files in the collection, or you hit none. Bounding box search is required by the STAC API standard.  Specify bounding box by listing: southwesterly point (lon,lat) followed by northeasterly point (lon, lat)
        ...
        _param = self._get_wamdw_features_serialize(
            datetime=datetime,
            model_run=model_run,
            sortorder=sortorder,
            limit=limit,
    ...
    @validate_call
    def get_wamdw_features_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the WAM files for the forecast steps in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide forecast data for the last 2 days")] = None,
        model_run: Annotated[Optional[StrictStr], Field(description="Filter on time the forecast was calculated, ie. which run it was part of. Input must be RFC3339 https://tools.ietf.org/html/rfc3339 format.  The inputted timestamp must match exactly. The following examples are illustrative and will not return data, since DMI only provide WAM forecast files for the last 2 days.")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Ordering of returned results. Default is unsorted")] = None,
    ...
    @validate_call
    def get_wamdw_features_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the WAM files for the forecast steps in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide forecast data for the last 2 days")] = None,
        model_run: Annotated[Optional[StrictStr], Field(description="Filter on time the forecast was calculated, ie. which run it was part of. Input must be RFC3339 https://tools.ietf.org/html/rfc3339 format.  The inputted timestamp must match exactly. The following examples are illustrative and will not return data, since DMI only provide WAM forecast files for the last 2 days.")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Ordering of returned results. Default is unsorted")] = None,
    ...
    def _get_wamdw_features_serialize(
        self,
        datetime,
        model_run,
        sortorder,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/forecastdata/collections/wam_dw/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_wamnatlant_features(
        ...
        _param = self._get_wamnatlant_features_serialize(
            datetime=datetime,
            model_run=model_run,
            sortorder=sortorder,
            limit=limit,
    ...
    @validate_call
    def get_wamnatlant_features_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the WAM files for the forecast steps in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide forecast data for the last 2 days")] = None,
        model_run: Annotated[Optional[StrictStr], Field(description="Filter on time the forecast was calculated, ie. which run it was part of. Input must be RFC3339 https://tools.ietf.org/html/rfc3339 format.  The inputted timestamp must match exactly. The following examples are illustrative and will not return data, since DMI only provide WAM forecast files for the last 2 days.")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Ordering of returned results. Default is unsorted")] = None,
    ...
    @validate_call
    def get_wamnatlant_features_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the WAM files for the forecast steps in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide forecast data for the last 2 days")] = None,
        model_run: Annotated[Optional[StrictStr], Field(description="Filter on time the forecast was calculated, ie. which run it was part of. Input must be RFC3339 https://tools.ietf.org/html/rfc3339 format.  The inputted timestamp must match exactly. The following examples are illustrative and will not return data, since DMI only provide WAM forecast files for the last 2 days.")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Ordering of returned results. Default is unsorted")] = None,
    ...
    def _get_wamnatlant_features_serialize(
        self,
        datetime,
        model_run,
        sortorder,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/forecastdata/collections/wam_natlant/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_wamnsb_feature_by_id(
        ...
        _param = self._get_wamnsb_feature_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_wamnsb_feature_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_wamnsb_feature_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_wamnsb_feature_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/forecastdata/collections/wam_nsb/items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_wamnsb_feature_by_id1(
        ...
        _param = self._get_wamnsb_feature_by_id1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_wamnsb_feature_by_id1_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_wamnsb_feature_by_id1_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_wamnsb_feature_by_id1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/forecastdata/collections/wam_natlant/items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_wamnsb_features(
        ...
        _param = self._get_wamnsb_features_serialize(
            datetime=datetime,
            model_run=model_run,
            sortorder=sortorder,
            limit=limit,
    ...
    @validate_call
    def get_wamnsb_features_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the WAM files for the forecast steps in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide forecast data for the last 2 days")] = None,
        model_run: Annotated[Optional[StrictStr], Field(description="Filter on time the forecast was calculated, ie. which run it was part of. Input must be RFC3339 https://tools.ietf.org/html/rfc3339 format.  The inputted timestamp must match exactly. The following examples are illustrative and will not return data, since DMI only provide WAM forecast files for the last 2 days.")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Ordering of returned results. Default is unsorted")] = None,
    ...
    @validate_call
    def get_wamnsb_features_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Returns the WAM files for the forecast steps in the provided time range.  Note: The provided examples are most likely outdated, and contains no data. This is because DMI only provide forecast data for the last 2 days")] = None,
        model_run: Annotated[Optional[StrictStr], Field(description="Filter on time the forecast was calculated, ie. which run it was part of. Input must be RFC3339 https://tools.ietf.org/html/rfc3339 format.  The inputted timestamp must match exactly. The following examples are illustrative and will not return data, since DMI only provide WAM forecast files for the last 2 days.")] = None,
        sortorder: Annotated[Optional[StrictStr], Field(description="Ordering of returned results. Default is unsorted")] = None,
    ...
    def _get_wamnsb_features_serialize(
        self,
        datetime,
        model_run,
        sortorder,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/forecastdata/collections/wam_nsb/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
