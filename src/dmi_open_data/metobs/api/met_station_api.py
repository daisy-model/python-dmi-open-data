...
class MetStationApi:
    ...
    def _get_station_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/metObs/collections/station/items/{id}',
    ...
    def get_stations(
        ...
        status: Annotated[Optional[StrictStr], Field(description="Filter results by station status. Status can be either Active or Inactive. See station list <a href=\"https://opendatadocs.dmi.govcloud.dk/Data/Meteorological_Observation_Data_Stations\">here</a>")] = None,
        ...
        :type station_id: str
        :param status: Filter results by station status. Status can be either Active or Inactive. See station list <a href=\"https://opendatadocs.dmi.govcloud.dk/Data/Meteorological_Observation_Data_Stations\">here</a>
        :type status: str
    ...
    def _get_stations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/metObs/collections/station/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
