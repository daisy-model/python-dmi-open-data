...
from dmi_open_data.climatedata.api_response import ApiResponse, T as ApiResponseT
import dmi_open_data.climatedata.models
from dmi_open_data.climatedata import rest
from dmi_open_data.climatedata.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(dmi_open_data.climatedata.models, klass)
