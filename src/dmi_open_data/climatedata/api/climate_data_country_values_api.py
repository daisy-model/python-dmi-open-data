...
class ClimateDataCountryValuesApi:
    ...
    def get_country_value_by_id(
        ...
        _param = self._get_country_value_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_country_value_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_country_value_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_country_value_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/climateData/collections/countryValue/items/{id}',
    ...
    def get_country_values(
        self,
        country_id: Annotated[Optional[StrictStr], Field(description="Filter by countryId")] = None,
        ...
        time_resolution: Annotated[Optional[StrictStr], Field(description="Filter by time resolution (hour/day/month/year), ie. what type of time interval the country value represents")] = None,
        ...
        bbox: Annotated[Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=4, max_length=6)]], Field(description="Select country values within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)")] = None,
        ...
        :param country_id: Filter by countryId
        :type country_id: str
        ...
        :type sortorder: str
        :param time_resolution: Filter by time resolution (hour/day/month/year), ie. what type of time interval the country value represents
        ...
        :type offset: int
        :param bbox: Select country values within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)
        ...
        _param = self._get_country_values_serialize(
    ...
    @validate_call
    def get_country_values_with_http_info(
        self,
        country_id: Annotated[Optional[StrictStr], Field(description="Filter by countryId")] = None,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Will filter to only include country values which starts within the specified time interval. Both the upper and lower limit is inclusive.<br/>As an illustrative example, if you asked for the interval 2004-03-12T14:00:00Z - 2004-04-14:15:00:00Z you would get:<ul>  <li>All hour country values in the range</li>  <li>All day values from 2004-03-13 until and including 2004-04-14. Day values for 2004-03-12 is excluded because 14:00:00Z is after the start of the day for any parameter/country combination.</li>  <li>The month values for 2004-04, because they starts sometime around 2004-04-01 depending on parameter</li></ul>")] = None,
        parameter_id: Annotated[Optional[StrictStr], Field(description="Filter by parameterId - see parameter list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Climate_Data#parameters\">here</a>")] = None,
    ...
    @validate_call
    def get_country_values_without_preload_content(
        self,
        country_id: Annotated[Optional[StrictStr], Field(description="Filter by countryId")] = None,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Will filter to only include country values which starts within the specified time interval. Both the upper and lower limit is inclusive.<br/>As an illustrative example, if you asked for the interval 2004-03-12T14:00:00Z - 2004-04-14:15:00:00Z you would get:<ul>  <li>All hour country values in the range</li>  <li>All day values from 2004-03-13 until and including 2004-04-14. Day values for 2004-03-12 is excluded because 14:00:00Z is after the start of the day for any parameter/country combination.</li>  <li>The month values for 2004-04, because they starts sometime around 2004-04-01 depending on parameter</li></ul>")] = None,
        parameter_id: Annotated[Optional[StrictStr], Field(description="Filter by parameterId - see parameter list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Climate_Data#parameters\">here</a>")] = None,
    ...
    def _get_country_values_serialize(
        self,
        country_id,
        datetime,
        parameter_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/climateData/collections/countryValue/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
