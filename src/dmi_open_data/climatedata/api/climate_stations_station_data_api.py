...
class ClimateStationsStationDataApi:
    ...
    def _get_station_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/climateData/collections/station/items/{id}',
    ...
    def get_stations(
        ...
        status: Annotated[Optional[StrictStr], Field(description="Filter results by station status. Status can be either Active or Inactive. See station list <a href=\"https://opendatadocs.dmi.govcloud.dk/Data/Climate_Data_Stations\">here")] = None,
        ...
        bbox: Annotated[Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=4, max_length=6)]], Field(description="Select station data within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)")] = None,
        ...
        :type datetime: str
        :param status: Filter results by station status. Status can be either Active or Inactive. See station list <a href=\"https://opendatadocs.dmi.govcloud.dk/Data/Climate_Data_Stations\">here
        :type status: str
        ...
        :type offset: int
        :param bbox: Select station data within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)
    ...
    def _get_stations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/climateData/collections/station/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
