...
class ClimateDataStationValuesApi:
    ...
    def get_station_value_by_id(
        ...
        _param = self._get_station_value_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_station_value_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_station_value_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_station_value_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/climateData/collections/stationValue/items/{id}',
    ...
    def get_station_values(
        ...
        time_resolution: Annotated[Optional[StrictStr], Field(description="Filter by time resolution (hour/day/month/year), ie. what type of time interval the station value represents")] = None,
        qc_status: Annotated[Optional[StrictStr], Field(description="Filter by qcStatus")] = None,
        validity: Annotated[Optional[StrictBool], Field(description="Filter by validity which can be true or false.")] = None,
        ...
        :type station_id: str
        :param datetime: datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Will filter to only include station values which starts within the specified time interval. Both the upper and lower limit is inclusive.<br/>As an illustrative example, if you asked for the interval 2004-03-12T14:00:00Z - 2004-04-14:15:00:00Z you would get:<ul>  <li>All hour station values in the range</li>  <li>All day values from 2004-03-13 until and including 2004-04-14. Day values for 2004-03-12 is excluded because 14:00:00Z is after the start of the day for any parameter/station combination.</li>  <li>The month values for 2004-04, because they starts sometime around 2004-04-01 depending on parameter and timezone the station is located in</li></ul>
        :type datetime: str
        ...
        :type sortorder: str
        :param time_resolution: Filter by time resolution (hour/day/month/year), ie. what type of time interval the station value represents
        :type time_resolution: str
        :param qc_status: Filter by qcStatus
        :type qc_status: str
        :param validity: Filter by validity which can be true or false.
        :type validity: bool
        ...
        _param = self._get_station_values_serialize(
    ...
    @validate_call
    def get_station_values_with_http_info(
        self,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Will filter to only include station values which starts within the specified time interval. Both the upper and lower limit is inclusive.<br/>As an illustrative example, if you asked for the interval 2004-03-12T14:00:00Z - 2004-04-14:15:00:00Z you would get:<ul>  <li>All hour station values in the range</li>  <li>All day values from 2004-03-13 until and including 2004-04-14. Day values for 2004-03-12 is excluded because 14:00:00Z is after the start of the day for any parameter/station combination.</li>  <li>The month values for 2004-04, because they starts sometime around 2004-04-01 depending on parameter and timezone the station is located in</li></ul>")] = None,
        parameter_id: Annotated[Optional[StrictStr], Field(description="Filter by parameterId - see parameter list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Climate_Data#parameters\">here</a>")] = None,
    ...
    @validate_call
    def get_station_values_without_preload_content(
        self,
        station_id: Annotated[Optional[StrictStr], Field(description="Filter by stationId")] = None,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  and dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339. Will filter to only include station values which starts within the specified time interval. Both the upper and lower limit is inclusive.<br/>As an illustrative example, if you asked for the interval 2004-03-12T14:00:00Z - 2004-04-14:15:00:00Z you would get:<ul>  <li>All hour station values in the range</li>  <li>All day values from 2004-03-13 until and including 2004-04-14. Day values for 2004-03-12 is excluded because 14:00:00Z is after the start of the day for any parameter/station combination.</li>  <li>The month values for 2004-04, because they starts sometime around 2004-04-01 depending on parameter and timezone the station is located in</li></ul>")] = None,
        parameter_id: Annotated[Optional[StrictStr], Field(description="Filter by parameterId - see parameter list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Climate_Data#parameters\">here</a>")] = None,
    ...
    def _get_station_values_serialize(
        self,
        station_id,
        datetime,
        parameter_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/climateData/collections/stationValue/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
