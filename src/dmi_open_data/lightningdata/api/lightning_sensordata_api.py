...
class LightningSensordataApi:
    ...
    def get_sensor_data(
        ...
        bbox: Annotated[Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=4, max_length=6)]], Field(description="Select sensor data within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)")] = None,
        ...
        :type sortorder: str
        :param bbox: Select sensor data within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat)
        ...
        _param = self._get_sensor_data_serialize(
            datetime=datetime,
            period=period,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_sensor_data_with_http_info(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        period: Annotated[Optional[StrictStr], Field(description="Period from which to return results. Alternative to using from/to parameters")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=300000, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    @validate_call
    def get_sensor_data_without_preload_content(
        self,
        datetime: Annotated[Optional[StrictStr], Field(description="datetime searching as specified in https://docs.opengeospatial.org/is/17-069r3/17-069r3.html#_parameter_datetime  an dates as specified in RFC3339 https://tools.ietf.org/html/rfc3339")] = None,
        period: Annotated[Optional[StrictStr], Field(description="Period from which to return results. Alternative to using from/to parameters")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=300000, strict=True, ge=1)]], Field(description="Maximum number of results to return")] = None,
    ...
    def _get_sensor_data_serialize(
        self,
        datetime,
        period,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/lightningdata/collections/sensordata/items',
    ...
    def get_sensor_data_by_id(
        ...
        _param = self._get_sensor_data_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_sensor_data_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_sensor_data_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_sensor_data_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/lightningdata/collections/sensordata/items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
