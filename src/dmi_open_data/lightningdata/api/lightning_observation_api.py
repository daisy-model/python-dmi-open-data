...
class LightningObservationApi:
    ...
    def get_observation(
        ...
        type: Annotated[Optional[StrictInt], Field(description="Filter by lightning type. Lightning types are defined <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Lightning_Data\">here</a>")] = None,
        ...
        :type sortorder: str
        :param type: Filter by lightning type. Lightning types are defined <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Lightning_Data\">here</a>
        :type type: int
    ...
    def _get_observation_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/lightningdata/collections/observation/items',
    ...
    def _get_observation_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/lightningdata/collections/observation/items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
