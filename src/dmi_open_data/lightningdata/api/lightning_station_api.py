...
from dmi_open_data.lightningdata.api_client import ApiClient, RequestSerialized
from dmi_open_data.lightningdata.api_response import ApiResponse
from dmi_open_data.lightningdata.rest import RESTResponseType


class LightningStationApi:
    ...
    def _get_station_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/lightningdata/collections/station/items/{id}',
    ...
    def get_stations(
        ...
        status: Annotated[Optional[StrictStr], Field(description="Filter results by station status. Status can be either Active or Inactive. See station list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Lightning_Data\">here</a>")] = None,
        ...
        sortorder: Annotated[Optional[StrictStr], Field(description="Order by which to return results. Default is not sorted. Only possible to sort by lastHeartbeat descending order.")] = None,
        ...
        heartbeat_max_age: Annotated[Optional[StrictInt], Field(description="Station filtering by lastHeartBeat. A stations will be returned only if a heartbeat was found within the last specified minutes.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type datetime: str
        :param status: Filter results by station status. Status can be either Active or Inactive. See station list <a href=\"https://opendatadocs.dmi.govcloud.dk/en/Data/Lightning_Data\">here</a>
        :type status: str
        :param limit: Maximum number of results to return
        :type limit: int
        :param offset: number of results to skip before returning matching results
        :type offset: int
        :param sortorder: Order by which to return results. Default is not sorted. Only possible to sort by lastHeartbeat descending order.
        :type sortorder: str
        ...
        :type bbox_crs: str
        :param heartbeat_max_age: Station filtering by lastHeartBeat. A stations will be returned only if a heartbeat was found within the last specified minutes.
        :type heartbeat_max_age: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _get_stations_serialize(
        ...
        if heartbeat_max_age is not None:
            ...
            _query_params.append(('heartbeatMaxAge', heartbeat_max_age))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/lightningdata/collections/station/items',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
