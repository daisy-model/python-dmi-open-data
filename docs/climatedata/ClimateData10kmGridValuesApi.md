# dmi_open_data.climatedata.ClimateData10kmGridValuesApi
 ...
 **time_resolution** | **str**| Filter by time resolution (hour/day/month/year), ie. what type of time interval the 10km grid value represents | [optional] 
 ...
 **bbox** | [**List[float]**](float.md)| Select 10km grid values within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat) | [optional] 
