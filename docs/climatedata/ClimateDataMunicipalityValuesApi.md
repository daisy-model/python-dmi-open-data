# dmi_open_data.climatedata.ClimateDataMunicipalityValuesApi
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **municipality_id** | **str**| Filter by municipalityId | [optional] 
 ...
 **time_resolution** | **str**| Filter by time resolution (hour/day/month/year), ie. what type of time interval the municipality value represents | [optional] 
 ...
 **bbox** | [**List[float]**](float.md)| Select municipality values within bounding box. Southwesterly point (lon,lat) followed by northeasterly point (lon, lat) | [optional] 
